...
% @
<<fig.pos="h",echo=FALSE,warning=F>>=
cat('tau =',tau(data5)[[1]])
cat('Cramer =',wspolczynniki(data5,'Cramer')[[1]])
cat('T-czuprow =',wspolczynniki(data5,'t-czuprow')[[1]])
cat('Phi =',wspolczynniki(data5,'phi')[[1]])
cat('Pearson =',wspolczynniki(data5,'pearson')[[1]])
@
...
<<fig.pos="h",echo=FALSE>>=
cat('tau =' ,tau(data6)[[1]])
cat('gamma =', wspolczynniki(data6,'gamma'))
@
