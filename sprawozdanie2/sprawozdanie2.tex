...
\end{kframe}
\end{knitrout}
W tym przypadku widzimy, że p-wartoś w każdym teście jest mniejsze niż 0,05, zatem odrzucamy hipotezę, 
że prawdopodobieństwo, że losowo wybrana osoba w wieku do 35 lat z badanej populacji w przypadku bólu zażywa Ibuprom jest większe bądź równe 1/5. 

Wynik ten jest inny niż w podpunkcie \textbf{c)}
\subsection*{Zad 3}
