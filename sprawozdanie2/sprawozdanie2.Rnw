...
tab <- xtable(zad2_df, digits=c(0,5,5),caption = 'Tablicza wartości współczynników inercji macierzy dla zadania 1.' ,label = "tab:5" )
print(tab, sanitize.text.function = function(x) {x},table.placement="H")
@
...
<<fig.width = 10, echo = F, fig.height = 6, fig.cap ='\\label{fig:1}Analiza korespondecji dla tabeli  m1a.' ,fig.pos = 'H'>>=
...
<<fig.width = 10, echo = F, fig.height = 6, fig.cap ='\\label{fig:2}Analiza korespondecji dla tabeli za m1b.' ,fig.pos = 'H'>>=
ggplot(df2, aes(x, y, label = name ,colour = col) ) +
    ...
    xlab("Dim 1") + ylab("Dim 2")
@
<<fig.width = 10, echo = F, fig.height = 6, fig.cap ='\\label{fig:3}Analiza korespondecji dla tabeli za m1c.' ,fig.pos = 'H'>>=
ggplot(df2, aes(x, y, label = name ,colour = col) ) +
	geom_point() + geom_text(vjust = -1) +
	scale_color_manual(values=c("#0000ff","#ff0000"))+
  	geom_hline(yintercept=0) + geom_vline(xintercept = 0)+
    xlab("Dim 1") + ylab("Dim 2")
@
<<fig.width = 10, echo = F, fig.height = 6, fig.cap ='\\label{fig:4}Analiza korespondecji dla tabeli za m2a.' ,fig.pos = 'H'>>=
ggplot(df2, aes(x, y, label = name ,colour = col) ) +
	geom_point() + geom_text(vjust = -1) +
	scale_color_manual(values=c("#0000ff","#ff0000"))+
  	geom_hline(yintercept=0) + geom_vline(xintercept = 0)+
