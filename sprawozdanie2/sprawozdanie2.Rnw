...
# rownames(zad2_df) <- c("m1a", "m1b", "m1c", "m2a")
colnames(l2zad3_df) <- c("$\\tau$", "V", "T", "$\\varphi $", "C") 
tab_l2zad3_df <- xtable(l2zad3_df, digits=c(0,5,5,5,5,5),caption = 'Tablica wartości współczynników dla zadania 2.' ,label = "tab:6" )
