...
@
	Jak widzmy p-wartość jest mniejsza niż 0.05, zatem odrzucamy hipotezę o niezależności rozkładów.
...
są odpowiednią liczbą wierszy i kolumn testowanej tabeli.
