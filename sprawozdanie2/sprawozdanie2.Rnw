...
ggplot(df2, aes(x, y, label = name ,colour = col) ) +
	...
	scale_color_manual(values=c("#0000ff","#ff0000"))+
  	geom_hline(yintercept=0) + geom_vline(xintercept = 0)
@
Na wykresie widzimy, że silne powiązanie występuje między zmiennymi "Ibuprom" oraz "do lat 35", zmienna "Paracetamol" także jest silnie powiązana, ale ze zmienną "powyżej 55lat". Natomiast lek "Ibuprofen" wykazuje najsilniejszą korespodencję z grupą wiekową "36-55lat".
\newpage
\subsection*{Zad 3}
