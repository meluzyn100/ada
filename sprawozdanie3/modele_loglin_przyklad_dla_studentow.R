...
# porównujemy licznoœci z modelem
cbind(mod1$data, fitted(mod1))

exp(4.17254+0.64931-0.31542+1.78511) #wartoœæ dla cigaretteyes, marijuanayes, alcoholyes
exp(4.17254+0-0.31542+1.78511) #wartoœæ dla cigaretteno, marijuanayes, alcoholyes itd.
...
exp(5.63342-1.88667-5.30904+0.48772+2.84789+2.05453+2.98601) #wartoœæ dla cigaretteyes, marijuanayes, alcoholyes
exp(5.63342+0-5.30904+0.48772+0+0+2.98601) #wartoœæ dla cigaretteno, marijuanayes, alcoholyes itd.
